    ...
    return (
        <section id="main-content-usefulInfo">          
            <div className="container-fluid h-100 p-0 m-0">
                ...
                <p><span className="subheading">* Chip/PIN transaction declined but magnetic swipe or manual entry is approved -</span> This is a sign the card may be counterfeit and you should not accept payment from the card if Chip/PIN failed. In case you do process the transaction by mag swipe or manually entering the card number, you may be liable if you receive a fraud chargeback.</p>
                <p><span className="subheading">* Prepaid third party bookings -</span> These are the highest risk of credit card fraud. The guest and the cardholder are different people and the cardholder will not be present. You may request the cardholder to send a scan of their ID and card however you cannot know if these have been stolen or not as the cardholder is not present to verify by sight or by chip/pin. Be aware of fake travel agent scams in which you will receive booking requests via a third party. Take note of the email address used by the alleged travel agent/booker and of the country of issue of the card card (BIN). You may search the internet for the first 6 digits of the credit card number which is called the BIN and indicates the card issuer bank and country. Be aware if multiple different credit cards are provided by the booker as this is an indication the card details have been stolen. You may run the alleged cardholder's ID through our Inquiry in case this same ID document was used at another hotel with stolen card details.</p>
                <p><span className="subheading">* Pre-Authorizations -</span> Make sure to always enter the pre-authorization amount for the exact same amount that you wish to complete the sale. The pre-authorization purpose is to check if the amount is available on the card and also if the card is active. If you take a pre-authorization for $1 you are asking the issuing bank if $1 can be charged. If you complete the sale for a higher amount you may receive a chargeback for no-authorization received.</p>
